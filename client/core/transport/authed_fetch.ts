...
// HttpSpacePrimitives (PdfViewer, HistoryPanel, sync push/pull, config,
// the page-list rebuild). Token is set once at boot
// (client/core/client.ts) and held in module state - no per-fetch
// storage hit.
