...
// edits take effect without reloading. design.md Shortcut section: the 12
// rebindable actions and their default bindings (listed in spec order).
// (Keeping a version is intentionally NOT here - it lives only as the
// "Keep this version" button in the history panel.)

import { readUserPrefs, userPrefsVersion } from "../config/index.ts";
