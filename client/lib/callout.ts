...
export const builtinTemplates: Record<string, CalloutTemplate> = {
  definition: { title: "Definition", numbered: true, cssClass: "def" },
  proof: { title: "Proof.", italic: true, suffix: " ∎", cssClass: "proof" },
  theorem: { title: "Theorem", numbered: true, italic: true, cssClass: "thm" },
  proposition: { title: "Proposition", numbered: true, italic: true, cssClass: "prop" },
  lemma: { title: "Lemma", numbered: true, italic: true, cssClass: "lemma" },
  corollary: { title: "Corollary", numbered: true, italic: true, cssClass: "cor" },
